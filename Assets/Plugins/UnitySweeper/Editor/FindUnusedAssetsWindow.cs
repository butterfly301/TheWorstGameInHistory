...
namespace UnitySweeper
{
    ...
    {
        private readonly AssetCollector collection = new();
        private readonly List<DeleteAsset> deleteAssets = new();
        ...
        private void OnGUI()
        {
            ...
            if (GUILayout.Button("All", GUILayout.MaxWidth(100)))
                foreach (var asset in deleteAssets)
                {
                    ...
                    if (!CheckSearch(asset.path, searchTerm)) continue;
            ...
            if (GUILayout.Button("Exclude Plugins", GUILayout.MaxWidth(100)))
                foreach (var asset in deleteAssets)
                {
                    ...
                    if (asset.path.StartsWith("Assets/Plugins")) asset.isDelete = false;
                }
        ...
        /// <returns></returns>
        private bool CheckSearch(string path, string searchTerm)
        {
            ...
            foreach (var keyword in keywords)
            {
                ...
                else if (!path.Contains(curKeyword))
                {
                    return false;
                }
            }
        ...
        private void RemoveFiles()
        {
            try
            {
                ...
                foreach (var dir in Directory.GetDirectories("Assets")) RemoveEmptyDirectory(dir);
