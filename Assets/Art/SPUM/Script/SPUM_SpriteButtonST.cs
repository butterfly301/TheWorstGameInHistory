...
#pragma warning restore CS0618
        ...
        ChangeColorButton?.onClick.AddListener(() =>
        {
            if (IsActive)
                ...
                _Manager.UIManager.ToastOn(name + " No Selected");
        });
        ChangeRandomButton?.onClick.AddListener(() =>
        {
            if (IsActive || !IsSpriteFixed)
                ...
                _Manager.UIManager.ToastOn(name + " is Locked or No Selected");
        });
        ResetSpriteButton?.onClick.AddListener(() =>
            {
                if (!IsSpriteFixed)
                    ...
                    _Manager.UIManager.ToastOn(name + " is Locked");
            }
        );
        LockButton?.onClick.AddListener(() =>
        {
            ChangeLock();
            _Manager.UIManager.ToastOn(name + " is Locked " + IsSpriteFixed);
        });
    }
