...
public class ColorSelect : MonoBehaviour
{
    ...
    public void SetColorSave()
    {
        ...
        if (_savedColor.gameObject.activeInHierarchy) // 활성화 상태면
        {
            ...
            var parsedColor = ColorUtility.ToHtmlStringRGB(_savedColor.color);
            SoonsoonData.Instance._spumManager.UIManager.ToastOn($"Selected Color <color=#{parsedColor}>◆</color>#" +
                                                                 parsedColor);
        ...
        else
        {
            ...
            var parsedColor =
                ColorUtility.ToHtmlStringRGB(_savedColor
                    .color); // SoonsoonData.Instance._spumManager.UIManager.ColorToStr(_savedColor.color);
            SoonsoonData.Instance._spumManager.UIManager.ToastOn($"Saved Color <color=#{parsedColor}>◆</color>#" +
                                                                 parsedColor);
