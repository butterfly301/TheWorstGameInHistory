...
public class SPUM_PackagePanel : MonoBehaviour
{
    ...
    // 스테이트에 맞는 클립 정보 생성
    private void CreatePackageElementButton(SpumPackage packageData, SPUM_AnimationManager manager)
    {
        var spumPackageElements = packageData.SpumAnimationData;
