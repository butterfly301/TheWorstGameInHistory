...
namespace HotUpdate.SceneLoad.System
{
    ...
    public class SceneLoadSystem : AbstractSystem
    {
        ...
        {
            { LoadingScreenType.Default, AddressableKeys.Prefabs.UI.LoadingScreenDefault_Prefab },
            { LoadingScreenType.PlayThrough1, AddressableKeys.Prefabs.UI.Playthrough1.LoadingScreenPlayThrough1_Prefab},
            { LoadingScreenType.PlayThrough2, AddressableKeys.Prefabs.UI.Playthrough2.LoadingScreenPlayThrough2_Prefab },
            { LoadingScreenType.PlayThrough3, AddressableKeys.Prefabs.UI.Playthrough3.LoadingScreenPlayThrough3_Prefab }
        };
