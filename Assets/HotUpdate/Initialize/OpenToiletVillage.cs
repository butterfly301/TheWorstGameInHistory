...
using HotUpdate.Enemy;
    public class OpenToiletVillage : Open
    {
        ...
        private string musicName = AddressableKeys.Audio.BGM.Circulation_Mp3;
        ...
        IEnumerator InitializeUIManager()
        {
            ...
            AddressablesManager.Instance.LoadAssetAsync<GameObject>(AddressableKeys.Prefabs.UI.Playthrough1.Manager.UIManager1_Prefab, (handle) =>
            {
        ...
        IEnumerator InitializeEnemyManager()
        {
            ...
            var prefab =
                AddressablesManager.Instance.LoadAssetSynchronously<GameObject>(AddressableKeys.Prefabs.Enemy.Manager.EnemyManager_Prefab);
            if (prefab != null)
            {
        ...
        IEnumerator InitializePlayerAndCamera()
        {
            ...
            AddressablesManager.Instance.LoadAssetAsync<GameObject>(AddressableKeys.Prefabs.Camera.ToiletVillageCamera_Prefab,
                (handle) =>
                {
                    ...
                    AddressablesManager.Instance.LoadAssetAsync<GameObject>(
                        AddressableKeys.Prefabs.Character.Player.Player1_Prefab,
                        (handle2) =>
                        {
        ...
        IEnumerator InitializeToiletVillagePlatform()
        {
            ...
            AddressablesManager.Instance.LoadAssetAsync<GameObject>(AddressableKeys.Prefabs.World.ToiletVillagePlatform_Prefab,
                (handle) =>
                { 
