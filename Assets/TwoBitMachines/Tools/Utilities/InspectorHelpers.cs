...
namespace TwoBitMachines.Editors
{
    ...
    public static class Skin
    {
        ...
        {
            texture = texture == null ? square : texture;
        ...
        public static Rect TextureCentered(this Rect rect, Texture2D texture, Vector2 textureSize, Color color,
            int shiftY = 0)
        {
        ...
        {
            Draw(rect, color, texture == null ? Texture2D.whiteTexture : texture);
            return rect;
        }
    }
}
