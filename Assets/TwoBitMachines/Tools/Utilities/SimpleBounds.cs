...
namespace TwoBitMachines
{
    ...
    public class SimpleBounds
    {
        ...
        [SerializeField] public Vector2 size = new(10f, 5f);
        [NonSerialized] private Vector3 startOffset;
    ...
    public class Bounds
    {
        ...
        {
            return p.x > boundsLeft + buffer && p.x < boundsRight - buffer && p.y > boundsBottom + buffer &&
                   p.y < boundsTop - buffer;
        }
        ...
        {
            return boundsLeft < other.boundsRight && boundsRight > other.boundsLeft && boundsTop > other.boundsBottom &&
                   boundsBottom < other.boundsTop;
        }
    }
}