...
namespace TwoBitMachines
{
    ...
    public static class EasingFunction
    {
        ...
        public static TweenFunction[] operation =
        {
            EaseIn,
            EaseOut,
            EaseInOut,
        ...
        {
            if (t <= 0.5f) return EaseIn(t * 2) * 0.5f;
        ...
        {
            var bounce1Time = 0.60f;
            var bounce2Time = 0.25f;
            var bounce3Time = 0.15f; // all must add up to 1
            if (t <= 0)
                return 0;
            if (t <= bounce1Time)
