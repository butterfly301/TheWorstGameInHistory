...
namespace TwoBitMachines
{
    public static class SetTween
    {
        ...
        public static void Get(Act act, ref Vector3 from, ref Vector3 to, Transform T, RectTransform rectT,
            bool useAnchors)
        {
            if (rectT != null)
            {
                var rectPosition = useAnchors ? (Vector3)rectT.anchoredPosition : rectT.position;
        ...
        public static void Set(Act act, float value, Transform T, RectTransform rectT, bool useAnchors)
        {
            if (rectT != null)
            {
                ...
                if (useAnchors) rectT.anchoredPosition = rectPosition;
                if (!useAnchors) rectT.position = rectPosition;
            }
            else if (T != null)
            {
                if (act == Act.MoveToX)
                ...
                else if (act == Act.ScaleToZ) T.localScale = new Vector3(T.localScale.x, T.localScale.y, value);
            }
        }
        ...
        public static void Set(Act act, Vector2 value, Transform T, RectTransform rectT, bool useAnchors)
        {
            if (rectT != null)
            {
                ...
                if (act == Act.MoveTo2D)
                    ...
                    rectPosition = value;
                else if (act == Act.ScaleTo2D) rectT.localScale = new Vector3(value.x, value.y, rectT.localScale.z);
            ...
            else if (T != null)
            {
                if (act == Act.MoveTo2D)
                    ...
                    T.localPosition = new Vector3(value.x, value.y, T.localPosition.z);
                else if (act == Act.ScaleTo2D) T.localScale = new Vector3(value.x, value.y, T.localScale.z);
            }
        }
        ...
        public static void Set(Act act, Vector3 value, Transform T, RectTransform rectT, bool useAnchors)
        {
            if (rectT != null)
            {
                ...
                if (act == Act.MoveTo3D)
                    ...
                    rectPosition = value;
                else if (act == Act.ScaleTo3D) rectT.localScale = value;
            ...
            else if (T != null)
            {
                if (act == Act.MoveTo3D)
                    ...
                    T.localPosition = value;
                else if (act == Act.ScaleTo3D) T.localScale = value;
            }
        }

        public static void Rotate(Act act, ref float total, float deltaTime, float turns, float seconds, Transform T,
            RectTransform rectT)
        {
            var turnRate = TurnRate(ref total, deltaTime, turns, seconds);
            ...
            if (rectT != null)
            {
                ...
                else if (act == Act.RotateZ) rectT.Rotate(Vector3.forward, turnRate);
            }
            else if (T != null)
            {
                if (act == Act.RotateX)
                ...
                else if (act == Act.RotateZ) T.Rotate(Vector3.forward, turnRate);
            }
        }

        public static void RotateAround(Act act, Vector3 pivot, ref float total, float deltaTime, float turns,
            float seconds, Transform T, RectTransform rectT)
        {
            var turnRate = TurnRate(ref total, deltaTime, turns, seconds);
            ...
            if (rectT != null)
            {
                ...
                else if (act == Act.RotateAroundZ) rectT.RotateAround(pivot, Vector3.forward, turnRate);
            }
            else if (T != null)
            {
                if (act == Act.RotateAroundX)
                ...
                else if (act == Act.RotateAroundZ) T.RotateAround(pivot, Vector3.forward, turnRate);
            }
        }
        ...
        public static void SetQuaternion(Act act, Quaternion quaternion, Transform T, RectTransform rectT)
        {
            if (rectT != null)
            {
                if (act == Act.RotateTo) rectT.rotation = quaternion;
            }
            else if (T != null)
            {
                if (act == Act.RotateTo) T.rotation = quaternion;
            }
        }

        private static float TurnRate(ref float total, float deltaTime, float turns, float seconds)
        {
            var turn = Mathf.Abs(turns);
            var turnRate = turn * 360f * deltaTime;
            var limit = turn * seconds * 360f;

            if (total + turnRate > limit) turnRate = limit - total;
