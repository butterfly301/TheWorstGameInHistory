...
namespace TwoBitMachines.Editors
{
    ...
    public class TextMeshEffectEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                Fields.EventFoldOutEffectAndRate(parent.Get("onTyping"), parent.Get("worldEffect"),
                    parent.Get("typingRate"), parent.Get("typingFoldOut"), "On Typing", FoldOut.boxColor);
