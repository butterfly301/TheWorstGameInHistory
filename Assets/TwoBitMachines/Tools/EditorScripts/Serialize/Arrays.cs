...
namespace TwoBitMachines.Editors
{
    public static class Arrays
    {
        ...
        {
            property.intValue = Mathf.Clamp(property.intValue, 0, array.arraySize - 1);
        }
        ...
        {
            for (var i = array.arraySize; i < index + 1; i++)
            {
                array.arraySize++;
        ...
        {
            if (index >= 0 && index < array.arraySize) array.DeleteArrayElementAtIndex(index);
        }
