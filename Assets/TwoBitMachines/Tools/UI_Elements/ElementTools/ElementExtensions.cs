...
namespace TwoBitMachines.Editors
{
    public static class ElementExtensions
    {
        ...
        /// <summary>
        ///     Bind a serialized object to the visual element
        ///     <para />
        ///     BindProperty
        /// </summary>
        /// <param name="target"> Target VisualElement </param>
        ...
        /// <summary>
        ///     Bind a serialized property to the visual element
        ///     <para />
        ///     BindProperty
        /// </summary>
        /// <param name="target"> Target VisualElement </param>
        ...
        /// <summary>
        ///     Display tool tip information after user hovers over the element
        ///     <para />
        ///     tooltip
        /// </summary>
        /// <param name="target"> Target VisualElement </param>
        ...
        /// <summary>
        ///     Retrieve the tooltip string from this visual element
        ///     <para />
        ///     tooltip
        /// </summary>
        /// <param name="target"> Target VisualElement </param>
        ...
        /// <summary>
        ///     Initial main size of a flex item, on the main flex axis. The final layout might be smaller or larger, according to
        ///     the flex shrinking and growing determined by the flex property.
        ///     <para />
        ///     style.flexBasis
        /// </summary>
        /// <param name="target"> Target VisualElement </param>
