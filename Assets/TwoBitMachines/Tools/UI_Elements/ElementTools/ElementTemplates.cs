...
namespace TwoBitMachines.UIElement.Editor
{
    ...
    {
        public static List<Texture2D> icon = new();
        ...
        public static void Retrieve()
        {
            ...
            initialized = true;
            EditorTools.LoadGUI("TwoBitMachines", "/Tools/Icons", icon);
        }
    }
    ...
    public static class Tint
    {
        ...
        public static Color On => new Color32(77, 244, 99, 255);

        public static Color OnA => new Color32(77, 244, 99, 100);
        //Color: #f85a9d
    }
    ...
    public static class ElementTools
    {
                ...
                if (styleSheetProperty == null)
                    styleSheetProperty =
                        AssetDatabase.LoadAssetAtPath<StyleSheet>(
                            "Assets/TwoBitMachines/Tools/UI_Elements/Style/Style.uss");
        ...
        {
            var s = element.worldBound.size;
            var p = element.worldBound.position;
        ...
        public static VisualElement SetImage(this VisualElement element, string icon, Color? color = null,
            float scale = 1f)
        {
            return element.SetImage(Icon.Get(icon), color, scale);
        }

        public static VisualElement SetImage(this VisualElement element, Texture2D icon, Color? color = null,
            float scale = 1f)
        {
            var texture = icon;
            ...
            if (color != null && color.HasValue) element.style.unityBackgroundImageTintColor = color.Value;
            return element;
        }
    ...
    public static class Values
    {
        ...
        {
            if (obj is SerializedObject serializedObject) return serializedObject.FindProperty(field);

            if (obj is SerializedProperty serializedProperty) return serializedProperty.FindPropertyRelative(field);
            return null;
        }
        ...
        public static string PropertyPath(this object obj)
        {
            if (obj is SerializedProperty serializedProperty) return serializedProperty.propertyPath;
            return "";
        }
        ...
        public static Object Object(this object obj, string field)
        {
            return obj.Get(field).objectReferenceValue;
        }

        public static bool Bool(this object property, string field)
        {
            return property.Get(field).boolValue;
        }

        public static bool ReadBool(this object property, string field)
        {
            var boolProperty = property.Get(field);
            if (property == null)
                return false;
            var state = boolProperty.boolValue;
            boolProperty.boolValue = false;
            return state;
        }

        public static bool ReadBool(this object property)
        {
            var boolProperty = property as SerializedProperty;
            if (property == null)
                return false;
            var state = boolProperty.boolValue;
            boolProperty.boolValue = false;
        ...
        public static bool SetTrue(this object property, string field)
        {
            return property.Get(field).boolValue = true;
        }

        public static bool SetFalse(this object property, string field)
        {
            return property.Get(field).boolValue = false;
        }

        public static Sprite Sprite(this object property, string field)
        {
            return property.Get(field).objectReferenceValue as Sprite;
        }

        public static float Float(this object property, string field)
        {
            return property.Get(field).floatValue;
        }

        public static int Int(this object property, string field)
        {
            return property.Get(field).intValue;
        }

        public static int Enum(this object property, string field)
        {
            return property.Get(field).enumValueIndex;
        }

        public static string String(this object property, string field)
        {
        ...
        public static void Delete(this SerializedProperty array, int index, bool applyProperties = false)
        {
            ...
            array.arraySize--;
            if (applyProperties) array.serializedObject.ApplyProperties();
        }
        ...
        public static void Sort(this SerializedProperty array, string name = "name")
        {
            ...
            {
                var element1 = array.GetArrayElementAtIndex(i);
                var element2 = array.GetArrayElementAtIndex(j);
                if (element1.String(name).CompareTo(element2.String(name)) > 0) array.MoveArrayElement(j, i);
            }
        }
    ...
    {
        public static List<Object> newObjs = new();
        ...
        public static Button LargetButton(VisualElement parent, string label, Color buttonColor, Color labelColor,
            int fontSize = 12, string tooltip = "", bool bold = true)
        {
        ...
        public static VisualElement Button(VisualElement parent, string background, string icon, Color color,
            int flexGrow = 1, int height = 0, string tooltip = "")
        {
            ...
            element.RegisterCallback<MouseOutEvent>(evt => { element.style.unityBackgroundImageTintColor = color; });
            return element;
        }

        public static Button InputAndButton(VisualElement parent, string label, string icon, Color color,
            out TextField text, string name = "Name", int height = 25, string tooltip = "")
        {
            var element = new VisualElement();
            element.AddToClassList("box");
        ...
        public static VisualElement DropArea<T, U>(VisualElement container, int height, string background, Color color,
            int bottomSpace = 1)
        {
            ...
            dropArea.RegisterCallback<MouseOutEvent>(evt => { dropArea.style.unityBackgroundImageTintColor = color; });
            ...
            dropArea.RegisterCallback<DragExitedEvent>(evt => { DragAndDrop.visualMode = DragAndDropVisualMode.None; });
        ...
        public static VisualElement DropAreaMessage(this VisualElement container, string message, Color color,
            bool bold = true, int fontSize = 12)
        {
            var label = new Label();
            label.text = message;
            label.style.fontSize = fontSize;
            label.style.color = color;
            if (bold) label.AddToClassList("label-bold");
            container.Add(label);
            return container;
        }
        ...
        public static PropertyField Field(VisualElement parent, SerializedProperty field, int marginRight = 0,
            float weight = 1f)
        {
            var property = new PropertyField();
            property.AddToClassList("hide-label");
        ...
        public static BindableElement Header(VisualElement container, Color color, int height = 23, int space = 2,
            string backgroundImage = "Header")
        {
            var header = new BindableElement();
