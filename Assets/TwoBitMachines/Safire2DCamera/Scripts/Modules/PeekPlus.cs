...
namespace TwoBitMachines.Safire2DCamera
{
    ...
    public class PeekPlus
    {
        ...
        [SerializeField] public Vector2 distance = new(5f, 5f);
        ...
        private Vector3 Move(Follow follow)
        {
            ...
            {
                var directionX = horizontalStick != null && horizontalStick.Holding()
                    ? horizontalStick.valueV2
                    : Vector2.zero;
            ...
            {
                var directionY = verticalStick != null && verticalStick.Holding()
                    ? verticalStick.valueV2
                    : Vector2.zero;
...
#pragma warning disable format, 0414
        ...
        public static void CustomInspector(SerializedProperty parent, Color barColor, Color labelColor)
        {
            ...
            if (Follow.Open(parent, "Peek Plus", barColor, labelColor))
            {
                ...
                var typeX = (ControllerType)parent.Enum("controllerTypeX");
                var typeY = (ControllerType)parent.Enum("controllerTypeY");
