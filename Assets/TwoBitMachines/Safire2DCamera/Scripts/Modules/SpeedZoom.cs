...
namespace TwoBitMachines.Safire2DCamera
{
    ...
    public class SpeedZoom
    {
        ...
        [SerializeField] public List<SpeedZoomPacket> list = new();
        [NonSerialized] private Follow follow;

        [NonSerialized] private Vector3 previousPosition;
            ...
            if (Follow.Open(parent, "Speed Zoom", barColor, labelColor, true))
            {
                ...
                for (var i = 0; i < array.arraySize; i++)
                {
                    ...
                    FoldOut.Box(3, FoldOut.boxColor, offsetY: -2);
                    {
                        ...
                        element.Slider("Smooth", "smooth", 0.01f);
                    }
...
#pragma warning restore 0414
    ...
    public class SpeedZoomPacket
    {
        ...
        public bool Check(Vector2 speed, Zoom zoom)
        {
            ...
            {
                zoom.Set(scale, speed: smooth, isTween: false);
                return true;
            }
