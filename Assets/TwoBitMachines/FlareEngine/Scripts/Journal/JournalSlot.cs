...
namespace TwoBitMachines.FlareEngine
{
    public class JournalSlot : MonoBehaviour, IPointerDownHandler
    {
        ...
        [NonSerialized] public JournalObject journalObject;

        [NonSerialized] private Journal parent;
        ...
        public void Set(Journal parentRef, JournalObject journalObjectRef)
        {
            ...
            if (icon != null) icon.sprite = journalObject.Icon();
        }
        ...
        public void Select(bool callEvent = true)
        {
            ...
            {
                if (callEvent) slotClicked.Invoke();
            ...
            if (parent != null && journalObject != null)
            {
                ...
                if (parent.icon != null) parent.icon.sprite = journalObject.Icon();
            }
        }
        ...
        public void RefreshCompleteStatus()
        {
            ...
            if (journalObject is QuestSO && journalObject.Complete()) complete?.gameObject.SetActive(true);
            if (journalObject is QuestSO && !journalObject.Complete()) incomplete?.gameObject.SetActive(true);
        }
