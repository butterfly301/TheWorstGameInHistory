...
namespace TwoBitMachines
{
    ...
    {
        [SerializeField] private TweenParent tween = new();
        ...
        {
            if (gameObject.activeInHierarchy) Wiggle();
        }
        ...
        public void Wiggle()
        {
            ...
            if (tween.rectTransform == null && tween.transform == null) return;
        ...
        {
            if (impact.transform == null) return;
