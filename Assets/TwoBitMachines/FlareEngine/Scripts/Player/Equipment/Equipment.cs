...
namespace TwoBitMachines.FlareEngine
{
    public partial class Character
    {
        ...
        [NonSerialized] public ThePlayer.Melee melee;

        [NonSerialized] public float timeSwap;
        [NonSerialized] public List<Tool> tools = new();
        ...
        public bool ToggleOrActivate(bool toggleTool, string toolName)
        {
            if (toggleTool)
                ...
                (!ToolIsActive(toolName)) // if already active, do not activate again or else it will reset its angle
                ActivateTool(toolName);
            return true;
        }
        ...
        {
            itemEventData.success = ToggleOrActivateOnly(itemEventData.toggle, itemEventData.genericString);
            if (melee == null) melee = gameObject.GetComponent<ThePlayer.Melee>();
