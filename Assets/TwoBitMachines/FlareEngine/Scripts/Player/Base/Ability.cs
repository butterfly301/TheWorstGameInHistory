...
namespace TwoBitMachines.FlareEngine.ThePlayer
{
    ...
    public class Ability : MonoBehaviour
    {
        ...
        [SerializeField] [HideInInspector] public bool pause;
        [SerializeField] [HideInInspector] public List<string> exception = new();
        ...
        public virtual void ExecuteAbility(AbilityManager player, ref Vector2 velocity,
...
#pragma warning disable 0414
        ...
        public virtual bool OnInspector(SerializedObject controller, SerializedObject parent, string[] inputList,
        ...
        {
            return FoldOut.Bar(parent, barColor).Label(name, labelColor).BR("deleteAsk", "Delete")
                .BR("delete", "Close", execute: parent.Bool("deleteAsk"))
                .BRE("pause", "Pause2", Tint.Delete, Tint.PastelGreen).FoldOut();
        }
