...
namespace TwoBitMachines.FlareEngine.ThePlayer
{
    ...
    {
        [SerializeField] public ZipInfo zip = new();
...
#pragma warning disable 0414
            ...
            Color barColor, Color labelColor)
        {
            if (Open(parent, "Ziplining", barColor, labelColor))
            {
                ...
                {
                    Fields.EventFoldOutEffect(zip.Get("onStart"), zip.Get("onStartWE"), zip.Get("onStartFoldOut"),
                        "On Start", FoldOut.boxColor);
                    Fields.EventFoldOutEffect(zip.Get("onEnd"), zip.Get("onEndWE"), zip.Get("onEndFoldOut"), "On End",
                        FoldOut.boxColor);
                }
            }
