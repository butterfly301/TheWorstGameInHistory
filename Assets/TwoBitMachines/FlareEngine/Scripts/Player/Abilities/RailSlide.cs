...
namespace TwoBitMachines.FlareEngine.ThePlayer
{
    ...
    public class RailSlide : Ability
    {
        ...
        [SerializeField] public bool crouchSpeedBoost;
        [SerializeField] public bool forceDirection;
        ...
        [NonSerialized] private bool crouching;
        [NonSerialized] private float directionX = 1f;
        [NonSerialized] private bool exitTime;
        ...
        public override bool IsAbilityRequired(AbilityManager player, ref Vector2 velocity)
        {
            ...
            if (isSliding && player.world.onGround && !SlideOnLayer(player)) exitTime = true;
        ...
        {
            var onRail = SlideOnLayer(player);
            var totalBoost = speedBoost;
            var speed = player.walk.speed;
            ...
            if (player.world.onGround && onSlideRate > 0 && velocity.x != 0 &&
                Clock.Timer(ref slideRateCounter, onSlideRate))
            {
