...
namespace TwoBitMachines.FlareEngine.ThePlayer
{
    ...
    public class InfiniteWalk : Ability
    {
        ...
        [NonSerialized] public bool autoWallClimbing;

        [NonSerialized] public int direction;
        [NonSerialized] public bool infiniteWalking;
        ...
        public override bool IsAbilityRequired(AbilityManager player, ref Vector2 velocity)
        {
            ...
            if (infiniteWalking) return true;
        ...
        {
            if (!infiniteWalking) direction = player.playerDirection;
            ...
            if (autoWallClimbing && (!player.world.onWall || player.ground)) autoWallClimbing = false;
            if (player.world.leftWall && !player.world.onBridge) direction = 1;
            if (player.world.rightWall && !player.world.onBridge) direction = -1;
