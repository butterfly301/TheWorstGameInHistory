...
namespace TwoBitMachines.FlareEngine.ThePlayer
{
    ...
    public class PushBack : Ability
    {
        ...
        [SerializeField] public UnityEvent onPushBack = new();
        ...
        [NonSerialized] private bool flashActive;
        [NonSerialized] private float flashCounter;
        [NonSerialized] private float flashLimit;
        [NonSerialized] private float flashTimer;
        ...
        [NonSerialized] private int pushBackDirection;
        ...
        public void ResetFlash()
        {
            ...
            if (spriteRenderer != null) spriteRenderer.color = originColor;
            flashActive = false;
            flashToggle = false;
            flashCounter = 0;
            flashTimer = 0;
        ...
        public void ActivatePushBack(ImpactPacket impact)
        {
            ...
            flashTimer = flash <= 1 ? flashTime / 2f : flashTime / (flash * 2f);
            onPushBack.Invoke();
        }
        ...
        public override void EarlyExecute(AbilityManager player, ref Vector2 velocity)
        {
            ...
            if (flashLimit < Time.time) ResetFlash();
        }
            ...
            bool isRunningAsException = false)
        {
                ...
                0) //                                                   distance x is pushed linearly, vel y is treated as a jump
            {
                ...
                if (jumpForce != 0 && velocity.y == 0 && player.world.onGround) velocity.y = minJumpForce;
...
#pragma warning disable 0414
            ...
            Color barColor, Color labelColor)
        {
            if (Open(parent, "Push Back", barColor, labelColor))
            {
                ...
                Fields.EventFoldOut(parent.Get("onPushBack"), parent.Get("pushBackFoldOut"), "On Push Back",
