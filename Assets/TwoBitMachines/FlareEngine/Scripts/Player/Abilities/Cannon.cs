...
namespace TwoBitMachines.FlareEngine.ThePlayer
{
    ...
    public class Cannon : Ability
    {
        ...
        [NonSerialized] private float airFriction;
        [NonSerialized] private Transform cannon;
        [NonSerialized] private Vector2 direction;
        [NonSerialized] private bool follow;
        [NonSerialized] private float force;
        [NonSerialized] private float shootOffset;
            ...
            bool isRunningAsException = false)
        {
            ...
            else
            {
                ...
                if (player.world.onWall) direction.x = 0;
                if (player.world.onCeiling) direction.y = 0;
...
#pragma warning disable 0414
        ...
        {
            if (Open(parent, "Cannon", barColor, labelColor)) Layout.VerticalSpacing(3);
            return true;
        }
