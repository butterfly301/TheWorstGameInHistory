...
namespace TwoBitMachines.FlareEngine
{
    public class RebindInputButtonSO : MonoBehaviour
    {
        ...
        [SerializeField] public UnityEvent rebindStartEvent = new();
        [SerializeField] public UnityEvent rebindStopEvent = new();
        [SerializeField] public UpdateButtonBinding updateEvent = new();

        [NonSerialized] private bool binding;
...
#pragma warning disable 0414
        ...
        {
            if (inputButtonSO != null && bindingLabel != null) bindingLabel.SetText(inputButtonSO.InputName());
            if (inputButtonSO != null && buttonLabel != null && overrideButtonLabel)
                buttonLabel.SetText(inputButtonSO.buttonName);
            if (inputButtonSO != null) updateEvent?.Invoke(bindingLabel?.gameObject, inputButtonSO.InputName());
        }
