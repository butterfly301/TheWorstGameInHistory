...
{
    public class SetOldInputIcons : MonoBehaviour
    {
        [SerializeField] public GamepadIcons icons;

        protected void OnEnable()
        {
            var rebindUIComponents = transform.GetComponentsInChildren<RebindInputButtonSO>();
            foreach (var component in rebindUIComponents)
            {
                component.updateEvent.AddListener(OnUpdateBindingDisplay);
        ...
        {
            var icon = icons.GetSprite(controlPath);
