...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
      ...
      /// </summary>
      [CustomEditor(typeof(RebindNewInput))]
    public class RebindNewInputEditor : UnityEditor.Editor
    {
        private SerializedProperty m_ActionProperty;
        private SerializedProperty m_BindingIdProperty;

        private readonly GUIContent m_BindingLabel = new("Binding");
        private SerializedProperty m_BindingLabelProperty;
        private GUIContent[] m_BindingOptions;
        private string[] m_BindingOptionValues;
        private SerializedProperty m_ButtonLabelProperty;
        ...
        private SerializedProperty m_overrideButtonLabelProperty;
        ...
        protected void OnEnable()
        {
            ...
            m_ButtonLabelProperty = serializedObject.FindProperty("m_ButtonLabel");
            m_BindingLabelProperty = serializedObject.FindProperty("m_BindingLabel");
            m_overrideButtonLabelProperty = serializedObject.FindProperty("overrideButtonLabel");
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                EditorGUILayout.PropertyField(m_overrideButtonLabelProperty);
                EditorGUILayout.PropertyField(m_ButtonLabelProperty);
                EditorGUILayout.PropertyField(m_BindingLabelProperty);
