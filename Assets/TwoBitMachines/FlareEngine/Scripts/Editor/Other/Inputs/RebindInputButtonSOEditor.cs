        ...
        public override void OnInspectorGUI()
        {
            ...
            parent.Update();
            {
                FoldOut.Box(5, Tint.PurpleDark);
                {
                    ...
                    var type = parent.Enum("resetTypeTo");
                    parent.FieldDouble("Reset Key To", "resetTypeTo", "resetKeyTo", type == 0);
                    parent.FieldDouble("Reset Key To", "resetTypeTo", "resetMouseTo", type == 1);
                ...
                Fields.EventFoldOut(parent.Get("rebindStartEvent"), parent.Get("startFoldOut"), "Rebind Start",
                    color: Tint.Box);
                Fields.EventFoldOut(parent.Get("rebindStopEvent"), parent.Get("stopFoldOut"), "Rebind Stop",
                    color: Tint.Box);
            }
