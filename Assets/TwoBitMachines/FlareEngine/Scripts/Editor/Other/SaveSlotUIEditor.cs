    ...
    public class SaveSlotUIEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            parent.Update();
            {
                ...
                Fields.EventFoldOut(parent.Get("slotDataDeleted"), parent.Get("slotDataDeletedFoldOut"),
                    "Slot Data Deleted");
                Fields.EventFoldOut(parent.Get("slotIsInitialized"), parent.Get("slotIsInitializedFoldOut"),
                    "Slot Is Initialized");
                Fields.EventFoldOut(parent.Get("slotHasBeenInitialized"), parent.Get("slotHasBeenInitializedFoldOut"),
