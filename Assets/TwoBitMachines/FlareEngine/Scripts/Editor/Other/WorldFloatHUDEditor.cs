...
namespace TwoBitMachines.FlareEngine.Editors
{
    ...
    public class WorldFloatHUDEditor : UnityEditor.Editor
    {
        ...
        private void OnEnable()
        {
            ...
            if (main.discreteSaveKey == "") main.discreteSaveKey = Guid.NewGuid().ToString();
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            parent.Update();
            {
                ...
                Fields.EventFoldOut(parent.Get("onValueChanged"), parent.Get("eventFoldOut"), "On Value Changed",
                ...
                if (type == 0)
                {
                    var canIncrease = parent.Bool("canIncrease");
                    var height = canIncrease ? 1 : 0;
                    ...
                    FoldOut.Box(3 + height, FoldOut.boxColor);
                    {
                        ...
                        Labels.FieldText("Start Value", 18);
                        if (canIncrease)
