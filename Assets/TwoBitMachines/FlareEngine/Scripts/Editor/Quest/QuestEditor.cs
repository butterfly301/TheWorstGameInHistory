    ...
    public class QuestEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            parent.Update();
            {
                ...
                Fields.EventFoldOut(parent.Get("onQuestAccepted"), parent.Get("acceptFoldOut"), "On Quest Accepted",
                    color: FoldOut.boxColor);
                Fields.EventFoldOut(parent.Get("onQuestCompleted"), parent.Get("completeFoldOut"), "On Quest Completed",
                    color: FoldOut.boxColor);
            }
