...
namespace TwoBitMachines.FlareEngine.Editors
{
    ...
    public class WaterEditor : UnityEditor.Editor
    {
        ...
        public void OnSceneGUI()
        {
            ...
            var size = parent.Get("size").vector2Value;
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (create)
            {
                if (main.type == WaterType.Square)
                    main.CreateWaves();
                else if (main.waterMesh.readyToCreate) main.CreateWaves();
            }
        }
        ...
        public static void RenderWater(Water main)
        {
            ...
            if (EditorApplication.isPlaying && EditorApplication.isPaused)
                SceneView.duringSceneGui += main.DrawBatches;
            else if (!EditorApplication.isPlaying) SceneView.duringSceneGui += main.DrawBatches;
        }
