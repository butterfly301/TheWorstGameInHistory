...
namespace TwoBitMachines.FlareEngine.Editors
{
    ...
    public class AreaEffectEditor : UnityEditor.Editor
    {
        ...
        private void OnSceneGUI()
        {
            ...
            {
                var position = startPoint + main.fixedPosition[i];
                var newPosition = SceneTools.MovePositionCircleHandle(position, Vector2.zero, Color.green,
                    out var changed, handleSize: 0.5f);
            ...
            {
                var a = startPoint + main.fixedPosition[i];
                var b = startPoint + main.fixedPosition[i + 1];
                if (i == 0) Draw.GLLine(startPoint, a, Tint.Delete);
        ...
        public override void OnInspectorGUI()
        {
            ...
            else if (type == 3)
            {
                ...
                var arrayF = parent.Get("fixedPosition");
