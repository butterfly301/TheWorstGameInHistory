...
namespace TwoBitMachines.FlareEngine
{
    public class QuestSO : JournalObject
    {
        ...
        [SerializeField] public List<QuestRewards> rewards = new();
        [SerializeField] [HideInInspector] public SaveQuest saveQuest = new();
        ...
        public void LoadQuestStatus() // needs to be called at the beginning of the scene
        {
            if (!saveQuest.hasBeenLoaded)
            {
                ...
                saveQuest = Storage.Load(saveQuest, WorldManager.saveFolder, title);
            }
        }
        ...
        {
            for (var i = 0; i < rewards.Count; i++) rewards[i].ApplyReward();
        }
...
#pragma warning disable 0414
    ...
    public class QuestRewards
    {
        ...
        public void ApplyReward()
        {
            ...
            if (inventorySO != null && itemSO != null) inventorySO.AddToInventory(itemSO, 0);
        }
