...
namespace TwoBitMachines.FlareEngine
{
    ...
    public class LineOfSight
    {
        ...
        [NonSerialized] private bool changedDirection;
        [NonSerialized] private float previousAngle;
        ...
        public void ShootBeam(Transform weapon, Transform firePoint, ref bool fire)
        {
            ...
            for (var i = 0;
                 i < 25;
                 i++) // will ignore up to twenty-five edge colliders (arbitrary number), most of the time it will only execute once
            {
                var ray = Physics2D.Raycast(origin, weapon.right, maxLength, layer);
            ...
            var parent = beam.transform.parent;
            var scale = beam.transform.localScale;
            scale.x = parent != null
                ? actualDistance / parent.localScale.x
                : actualDistance; // keep the distance a 1: 1 incase parent is scaled
        ...
        private void RotateReticle(Transform weapon, Transform firePoint)
        {
            ...
            if (reticleType == ReticleType.FixedPosition)
            {
                ...
                var to = weapon.rotation *
                         Vector2.right; //Compute.RotateVector (characterRight * weaponDirection, rotate);
...
#pragma warning disable 0414
        ...
        [SerializeField] private bool onBeamHitFoldOut;
        [SerializeField] private bool onNothingHitFoldOut;
        [SerializeField] private bool onTargetHitFoldOut;
