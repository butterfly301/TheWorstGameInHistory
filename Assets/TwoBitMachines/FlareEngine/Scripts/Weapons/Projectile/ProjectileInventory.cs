...
namespace TwoBitMachines.FlareEngine
{
    ...
    {
        [SerializeField] public List<ProjectileBase> list = new();
        ...
        private void Awake()
        {
            ...
            for (var i = 0; i < list.Count; i++) list[i].inventory = this;
            SetUI();
        }
        ...
        public void SetUI()
        {
            if (enableUI && currentProjectile != null)
            {
                ...
                if (textMesh != null)
                    textMesh.text = string.Concat(currentProjectile.AmmoCount().ToString(), " / ",
                        currentProjectile.AmmoMax().ToString());
            }
        }
