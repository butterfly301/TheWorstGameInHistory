...
namespace TwoBitMachines.MapSystem
{
    ...
    public class Room
    {
        ...
        [SerializeField] public MeshData roomMesh = new();
        [SerializeField] public MeshData outlineMesh = new();
        [SerializeField] public List<Point> lineList = new();
        [SerializeField] public List<Point> pointList = new();
