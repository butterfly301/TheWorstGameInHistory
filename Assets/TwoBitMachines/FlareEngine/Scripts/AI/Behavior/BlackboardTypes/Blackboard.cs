...
namespace TwoBitMachines.FlareEngine.AI.BlackboardData
{
    ...
    public class Blackboard : MonoBehaviour
    {
        ...
        [HideInInspector] public bool hasNoTargets;

        public virtual GameObject GetNearestGameObjectTarget(Vector2 position)
        {
            return null;
        }

        public virtual GameObject GetRandomGameObjectTarget()
        {
            return null;
        }
        ...
        public virtual Transform GetNearestTransformTarget(Vector2 position)
        {
            return null;
        }

        public virtual Transform GetRandomTransformTarget()
        {
            return null;
        }
        ...
        public virtual Vector2 GetNearestTarget(Vector2 position)
        {
            return Vector2.zero;
        }

        public virtual Vector2 GetRandomTarget()
        {
            return Vector2.zero;
        }

        public virtual Vector2 GetTarget(int index = 0)
        {
            return Vector2.zero;
        }
        ...
        public virtual bool AddToList(GameObject gameObject)
        {
            return false;
        }

        public virtual bool AddToList(Transform transform)
        {
            return false;
        }

        public virtual bool AddToList(Vector3 vector3)
        {
            return false;
        }

        public virtual bool RemoveFromList(GameObject gameObject)
        {
            return false;
        }

        public virtual bool RemoveFromList(Transform transform)
        {
            return false;
        }

        public virtual bool RemoveFromList(Vector3 vector)
        {
            return false;
        }

        public virtual bool OnASurface()
        {
            return false;
        }

        public virtual NodeState NextTarget(ref Vector3 target, ref bool reversing, ref int index, Transform transform)
        {
        ...
        public virtual AITree GetTree()
        {
            return null;
        }

        public virtual AIFSM GetAIFSM()
        {
            return null;
        }
...
#pragma warning disable 0414
        ...
        [SerializeField] [HideInInspector] public List<string> refName = new();

        public virtual void OnSceneGUI(Editor editor)
        {
        }
