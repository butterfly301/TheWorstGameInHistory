...
namespace TwoBitMachines.FlareEngine.AI
{
    ...
    public class RandomSelector : Composite
    {
        public override NodeState RunNodeLogic(Root root)
        {
            ...
            if (nodeSetup == NodeSetup.NeedToInitialize) currentChildIndex = Random.Range(0, children.Count);
...
#pragma warning disable 0414
        ...
        {
            if (parent.Bool("showInfo")) Labels.InfoBoxTop(35, "This will run one random child node.");
