...
namespace TwoBitMachines.FlareEngine.AI
{
    ...
    public class SpawnPoint : Action
    {
        ...
        public override NodeState RunNodeLogic(Root root)
        {
            ...
            if (collider2DRef == null) collider2DRef = gameObject.GetComponent<Collider2D>();
        ...
        public override bool OnInspector(AIBase ai, SerializedObject parent, Color color, bool onEnable)
        {
            if (parent.Bool("showInfo"))
                Labels.InfoBoxTop(65,
                    "Reset the AI to the position and angle it had at the beginning of the scene. This will also enable its collider2D." +
                    "\n \nReturns Success");
            return true;
        }
