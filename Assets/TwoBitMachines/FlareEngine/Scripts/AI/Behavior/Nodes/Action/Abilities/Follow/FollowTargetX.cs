...
namespace TwoBitMachines.FlareEngine.AI
{
    ...
    public class FollowTargetX : Action
    {
        ...
        public override NodeState RunNodeLogic(Root root)
        {
            ...
            if (nodeSetup == NodeSetup.NeedToInitialize) velocityX = 0;
            ...
            if ((t - root.position).sqrMagnitude <= radius * radius) return NodeState.Success;
        ...
        public override bool OnInspector(AIBase ai, SerializedObject parent, Color color, bool onEnable)
        {
            if (parent.Bool("showInfo"))
                Labels.InfoBoxTop(60,
                    "Follow a target in the x direction. Returns Success if target is within the radius." +
