...
namespace TwoBitMachines.FlareEngine.AI
{
    ...
    public class GrabPlayer : Action
    {
        ...
        [NonSerialized] private float counterGrab;
        [NonSerialized] private float counterHold;

        [NonSerialized] private int direction;
        [NonSerialized] private bool foundPlayer;
        ...
        public override NodeState RunNodeLogic(Root root)
        {
            ...
            if (nodeSetup == NodeSetup.NeedToInitialize)
            {
                ...
                if (health == null) health = player.gameObject.GetComponent<Health>();
            }
        ...
        {
            if (foundPlayer && player != null) player.BlockInput(false);
        }
