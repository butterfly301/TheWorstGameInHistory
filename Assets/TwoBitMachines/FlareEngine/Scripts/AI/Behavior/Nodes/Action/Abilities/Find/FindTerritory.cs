...
namespace TwoBitMachines.FlareEngine.AI
{
    ...
    public class FindTerritory : Conditional
    {
        ...
        {
            if (target == null || territory == null) return NodeState.Failure;
            if (nodeSetup == NodeSetup.NeedToInitialize) state = State.Waiting;
...
#pragma warning disable 0414
        ...
        public override bool OnInspector(AIBase ai, SerializedObject parent, Color color, bool onEnable)
        {
            if (parent.Bool("showInfo"))
                Labels.InfoBoxTop(40,
                    "Find the specified Territory. Use the found and exit events. Returns Success on exit.");
            FoldOut.Box(2, color, 5, -2);
            {
