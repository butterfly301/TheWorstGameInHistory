...
namespace TwoBitMachines.FlareEngine.AI
{
    ...
    public class FollowBezierPath : Action
    {
        ...
        [NonSerialized] public bool inReverse;
        [NonSerialized] public float shift;

        public override NodeState RunNodeLogic(Root root)
        {
            if (bezierPath == null) return NodeState.Failure;
            ...
            var newPosition = bezierPath.FollowPath(root.position, this, ref index, out var complete);
...
#pragma warning disable 0414
        public override bool OnInspector(AIBase ai, SerializedObject parent, Color color, bool onEnable)
        {
            if (parent.Bool("showInfo"))
                Labels.InfoBoxTop(60,
                    "Follow the bezier path. Time is the duration it takes to complete a segment in the path." +
