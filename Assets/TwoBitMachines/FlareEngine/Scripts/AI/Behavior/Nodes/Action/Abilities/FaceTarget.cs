...
namespace TwoBitMachines.FlareEngine.AI
{
    ...
    public class FaceTarget : Action
    {
        ...
        public override NodeState RunNodeLogic(Root root)
        {
            ...
            if (spriteRenderer == null) spriteRenderer = transform.gameObject.GetComponent<SpriteRenderer>();

            var targetIsLeft = target.GetTarget().x <= root.position.x;

            if (target.hasNoTargets) return NodeState.Success;
