...
#pragma warning disable 0414
        ...
        public override bool OnInspector(AIBase ai, SerializedObject parent, Color color, bool onEnable)
        {
            ...
            parent.Field("Float", "floatVal", index == 0);
            parent.Field("Int", "floatVal", index == 1);
            parent.Field("Bool", "boolVal", index == 2);
            parent.Field("Vector", "vectorVal", index == 3);
            parent.Field("String", "stringVal", index == 4);
            parent.Field("Transform", "transformVal", index == 5);
            parent.Field("GameObject", "transformVal", index == 6);
