...
namespace TwoBitMachines.FlareEngine.AI
{
    ...
    public class SetWorldFloat : Action
    {
        ...
        {
            if (worldFloat == null) worldFloat = gameObject.GetComponent<WorldFloat>();
        ...
        public override bool OnInspector(AIBase ai, SerializedObject parent, Color color, bool onEnable)
        {
            if (parent.Bool("showInfo"))
                Labels.InfoBoxTop(55,
                    "Set the WorldFloat value. If the reference is empty, the WorldFloat on this object will be used." +
                    "\n \nReturns Success");
