...
namespace TwoBitMachines.FlareEngine.AI
{
    ...
    public class CombinationLock : Action
    {
        ...
        [NonSerialized] private readonly List<int> answer = new();

        [NonSerialized] private bool answerIsTrue;
        [NonSerialized] private readonly List<int> keys = new();
        ...
        {
            var numberString = Mathf.Abs(keyCode).ToString();
        ...
        public void CheckAnswer(bool clearAnswerOnFail)
        {
            ...
            {
                onFailed.Invoke();
                if (clearAnswerOnFail) ClearAnswer();
                return;
            }
        ...
        public override bool OnInspector(AIBase ai, SerializedObject parent, Color color, bool onEnable)
        {
            if (parent.Bool("showInfo"))
                Labels.InfoBoxTop(45,
                    "Returns Success if the answer entered matches the key code. Call EnterKey() and CheckAnswer().");

            FoldOut.Box(1, color, 5, -2);
            {
