...
namespace TwoBitMachines.FlareEngine.AI
{
    ...
    public class FindCollider : Action
    {
        ...
        {
            if (beginSearch && Compute.ContainsLayer(colliderLayer, collider.gameObject.layer)) found = true;
        }
        ...
        public override bool OnInspector(AIBase ai, SerializedObject parent, Color color, bool onEnable)
        {
            if (parent.Bool("showInfo"))
                Labels.InfoBoxTop(70,
                    "Use OnTriggerEnter2D and OnTriggerStay2D to detect a collider. Set the collider" +
