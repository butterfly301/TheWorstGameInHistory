...
{
    [AddComponentMenu("")]
    public class WorldFloatSOLogic : Conditional
    {
        [SerializeField] public WorldFloatSO variable;
        ...
        [SerializeField] public WorldFloatSO compareVariable;
...
#pragma warning disable 0414
        ...
        {
            if (parent.Bool("showInfo")) Labels.InfoBoxTop(35, "Compare a world floatSO to a float value.");
