...
namespace TwoBitMachines.FlareEngine.AI
{
    ...
    public class WorldEffect : Action
    {
        ...
        {
            if (worldEffects == null) worldEffects = WorldEffects.get;
            if (worldEffects == null) return NodeState.Failure;
            var effect = ImpactPacket.impact.Set(effectName, root.position, Vector2.zero);
