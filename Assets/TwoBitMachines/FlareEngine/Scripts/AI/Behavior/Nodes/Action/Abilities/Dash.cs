...
namespace TwoBitMachines.FlareEngine.AI
{
    ...
    public class Dash : Action
    {
        ...
        [NonSerialized] private bool isDashing;
        ...
        public override void OnReset(bool skip = false, bool enteredState = false)
        {
            ...
            if (!canTakeDamage && health != null) health.CanTakeDamage(true);
        }
        ...
        public override NodeState RunNodeLogic(Root root)
        {
            ...
            if (nodeSetup == NodeSetup.NeedToInitialize)
            {
                ...
                if (changeHeight) root.world.box.ChangeColliderHeight(height);
                if (!canTakeDamage && health != null) health.CanTakeDamage(false);
            }
        ...
        private void DashNow(Root root)
        {
            ...
            var oldVelX = root.velocity.x;
            var targetSpeed = type == DashType.ConstantVelocity ? direction * speed : 0;
            ...
            if (lerpTime >= time)
            {
                ...
                if (!isDashing && !canTakeDamage && health != null) health.CanTakeDamage(true);
            }
        }
        ...
        public override bool OnInspector(AIBase ai, SerializedObject parent, Color color, bool onEnable)
        {
            if (parent.Bool("showInfo"))
                Labels.InfoBoxTop(65,
                    "Dash towards the target for the specified time. The AI can also change its height while dashing. Signals: dashing" +
