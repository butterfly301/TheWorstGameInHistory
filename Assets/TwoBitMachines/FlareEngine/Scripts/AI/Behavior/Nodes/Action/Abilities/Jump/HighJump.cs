...
namespace TwoBitMachines.FlareEngine.AI
{
    ...
    public class HighJump : Action
    {
        ...
        public override NodeState RunNodeLogic(Root root)
        {
            ...
            // Find Exit
            if (type == 1 && root.world.onGround) return NodeState.Success;
            if (type == 2 && !Found(root)) return NodeState.Success;
            if (type == 4 && !Found(root)) return NodeState.Success;
            if (type == 3 && !Found(root)) oldBoost = null;
            // Latch
            ...
            if (type == 1)
            {
                ...
                if (force.x != 0) root.velocity.x = force.x;
            ...
            else if (type == 3)
            {
                ...
                if (counter >= time || root.velocity.magnitude >= force.magnitude) return NodeState.Success;
                root.velocity = force;
        ...
        {
            return Interactables.HighJump.Find(root.world, root.velocity.y, ref type, ref timer, ref force,
                ref oldBoost);
        }
