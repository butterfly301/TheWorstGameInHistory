...
namespace TwoBitMachines.FlareEngine.AI
{
    ...
    public class SetWorldBool : Action
    {
        ...
        {
            if (worldBool == null) worldBool = gameObject.GetComponent<WorldBool>();
        ...
        public override bool OnInspector(AIBase ai, SerializedObject parent, Color color, bool onEnable)
        {
            if (parent.Bool("showInfo"))
                Labels.InfoBoxTop(55,
                    "Set the WorldBool value. If the reference is empty, the WorldBool on this object will be used." +
                    "\n \nReturns Success");
