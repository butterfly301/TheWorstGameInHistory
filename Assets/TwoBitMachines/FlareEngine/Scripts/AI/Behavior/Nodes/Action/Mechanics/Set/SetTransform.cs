...
namespace TwoBitMachines.FlareEngine.AI
{
    ...
    public class SetTransform : Action
    {
        ...
        [NonSerialized] private Vector3 currentValue = Vector3.zero;
        [NonSerialized] private Vector3 startValue = Vector3.zero;
        ...
        public override NodeState RunNodeLogic(Root root)
        {
            ...
            var t = targetTransform.GetTransform();
            if (t == null)
                return NodeState.Failure;
            ...
            if (lerp)
            {
                ...
                var percent = time == 0 ? 1f : counter / time;
        ...
        public override bool OnInspector(AIBase ai, SerializedObject parent, Color color, bool onEnable)
        {
            if (parent.Bool("showInfo"))
                Labels.InfoBoxTop(75,
                    "Set the position, rotation, or scale of a transform instantly or by lerping. This should not be used by a moving platform unless it's for the reset state." +
                    "\n \nReturns Running, Success, Failure");

            var type = parent.Enum("type");
            if (type == 0)
            {
                var positionType = parent.Enum("positionType");
                ...
                parent.Field("Vector", "value", positionType == 0);
                parent.Field("Transform", "positionTransform", positionType == 1);
                if (positionType == 2)
