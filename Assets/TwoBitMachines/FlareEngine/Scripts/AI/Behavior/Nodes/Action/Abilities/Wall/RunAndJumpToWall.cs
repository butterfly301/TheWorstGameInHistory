...
namespace TwoBitMachines.FlareEngine.AI
{
    ...
    public class RunAndJumpToWall : Action
    {
        ...
        [SerializeField] public Vector2 jump = new(8f, 5f);
        ...
        public override NodeState RunNodeLogic(Root root)
        {
            ...
            if (state == State.Run)
            {
                ...
                var hit = Physics2D.Raycast(root.world.box.center, Vector2.right * direction, jump.x + 0.5f,
            ...
            {
                root.velocity.y = 0;
                if (TwoBitMachines.Clock.Timer(ref counter, holdTime)) return NodeState.Success;
            }
