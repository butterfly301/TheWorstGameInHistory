...
namespace TwoBitMachines.FlareEngine.AI
{
    ...
    public class OverlapBox : Conditional
    {
        ...
        {
            var collider2D = Physics2D.OverlapBox(origin.GetTarget(), size, angle, layer);
        ...
        public bool CastAll(Root root)
        {
            ...
            var i = Physics2D.OverlapBox(origin.GetTarget(), size, angle, Root.filter2D, Root.colliderResults);
            if (origin.hasNoTargets) return false;
            return i > 0;
        }
