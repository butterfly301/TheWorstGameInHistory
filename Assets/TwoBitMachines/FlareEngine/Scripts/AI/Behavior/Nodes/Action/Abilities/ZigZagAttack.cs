...
namespace TwoBitMachines.FlareEngine.AI
{
    ...
    public class ZigZagAttack : Action
    {
        ...
        [NonSerialized] private Vector2 attackDirection;
        [NonSerialized] public int attackIndex;
        [NonSerialized] public float refVelX;
        ...
        public override NodeState RunNodeLogic(Root root)
        {
            ...
            else
            {
                ...
                if (attackIndex >= attacks) return NodeState.Success;
                root.velocity = attackDirection * speed;
            }
        ...
        public override bool OnInspector(AIBase ai, SerializedObject parent, Color color, bool onEnable)
        {
            if (parent.Bool("showInfo"))
                Labels.InfoBoxTop(65,
                    "Attack in a zig zag pattern, bouncing off walls. This requires an enclosed room with four walls." +
