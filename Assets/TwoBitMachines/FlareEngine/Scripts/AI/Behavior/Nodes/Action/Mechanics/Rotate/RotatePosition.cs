...
namespace TwoBitMachines.FlareEngine.AI
{
    ...
    public class RotatePosition : Action
    {
        ...
        public void Start()
        {
            var newDirection = Compute.RotateVector(Vector2.right, offset);
        ...
        public override NodeState RunNodeLogic(Root root)
        {
            ...
            if (Time.deltaTime != 0)
            {
                ...
                var direction = (startPoint - center) / radius;
                var newDirection = Compute.RotateVector(direction, speed * Time.deltaTime);
                var endPoint = center + newDirection * radius;
...
#pragma warning disable 0414
        ...
        public override void OnSceneGUI(Editor editor)
        {
            ...
            center = SceneTools.MovePositionCircleHandle(center, Vector2.zero, Tint.White, out var changed);
