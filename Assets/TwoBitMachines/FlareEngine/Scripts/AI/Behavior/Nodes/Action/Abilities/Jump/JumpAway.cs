...
namespace TwoBitMachines.FlareEngine.AI
{
    ...
    public class JumpAway : Action
    {
        ...
        public override NodeState RunNodeLogic(Root root)
        {
            ...
            {
                if (!root.world.onGround && !forceJump) return NodeState.Failure;
        ...
        public override bool OnInspector(AIBase ai, SerializedObject parent, Color color, bool onEnable)
        {
            if (parent.Bool("showInfo"))
                Labels.InfoBoxTop(75,
                    "Jump away from the target. If AI is not on ground, force jump will force it to jump. Signals: jumpAwayLeft, jumpAwayRight" +
