...
namespace TwoBitMachines.FlareEngine.AI
{
    ...
    public class WallSlide : Action
    {
        ...
        [SerializeField] public Vector2 hop = new(3f, 3f);
        [SerializeField] public bool hopOff;
        [NonSerialized] public float accelerate;
        [NonSerialized] public float counter;
        [NonSerialized] public bool isHoping;
        ...
        public override NodeState RunNodeLogic(Root root)
        {
            ...
            if ((!hopOff && !root.world.onWall) || root.world.onGround) return NodeState.Success;
            if (isHoping)
            {
            ...
            else
            {
                ...
                if (hopOff)
                {
                    var hit = Physics2D.Raycast(root.world.box.bottomCenter, Vector2.down, hop.y,
