...
namespace TwoBitMachines.FlareEngine.AI
{
    ...
    public class JumpTo : Action
    {
        ...
        [NonSerialized] public bool bypass;
        [NonSerialized] public float velocityXReference;
        ...
        public override NodeState RunNodeLogic(Root root)
        {
            ...
            {
                if (!root.world.onGround && !bypass) return NodeState.Failure;
                bypass = false;
                var distanceX = (target.GetTarget().x - root.position.x) * scaleDistance;
        ...
        public override bool OnInspector(AIBase ai, SerializedObject parent, Color color, bool onEnable)
        {
            if (parent.Bool("showInfo"))
                Labels.InfoBoxTop(110,
                    "If on the ground, the AI will jump towards the specified target. Clamp how far in the x direction the AI can jump." +
