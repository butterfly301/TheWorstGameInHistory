...
#pragma warning disable 0414
        ...
        [SerializeField] public int fsmIndex;
        ...
        [SerializeField] public List<string> refName = new();
        [SerializeField] public List<NodeMessage> message = new();

        public Rect GetRect(Vector2 offset = default)
        {
        ...
        {
            return nodeType == NodeType.Composite;
        }
