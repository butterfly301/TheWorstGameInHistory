...
namespace TwoBitMachines.FlareEngine.AI.BlackboardData
{
    ...
    public class TargetPathfinding : TargetPathfindingBase
    {
        ...
        public override void ResetState(WorldCollision world, Gravity gravity, AnimationSignals signals, Vector2 target)
        {
            ...
            var targetNode = map.PositionToNode(target + map.cellYOffset);
        ...
        {
            if (map == null || currentNode == null || targetRef == null || map.jobGrid.Length == 0) return;

            var targetNode = map.PositionToNode(targetRef.GetTarget() + map.cellYOffset);
            ...
            var calculateJob = new PathfindingJob
            {
                linesX = map.linesX,
                linesY = map.linesY,
                jobGrid = map.jobGrid,
