...
namespace TwoBitMachines.FlareEngine.Interactables
{
    ...
    {
        [SerializeField] private List<LadderInstance> ladder = new();
        ...
        {
            for (var i = 0; i < ladder.Count; i++) ladder[i].editorCheck = false;
