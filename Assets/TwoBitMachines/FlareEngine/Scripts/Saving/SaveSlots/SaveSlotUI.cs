...
namespace TwoBitMachines.FlareEngine
{
    public class SaveSlotUI : MonoBehaviour, IDeselectHandler, IPointerDownHandler
    {
        ...
        [SerializeField] public UnityEvent slotClicked = new();
        [SerializeField] public UnityEvent slotSelected = new();
        [SerializeField] public UnityEvent slotDataDeleted = new();
        [SerializeField] public UnityEvent slotIsInitialized = new();
        [SerializeField] public UnityEvent slotHasBeenInitialized = new();

        [NonSerialized] private SaveMenu master;
        ...
        public void SetTotalPlayTime(SaveSlot slot)
        {
            ...
            var hours = TimeSpan.FromSeconds(slot.totalTime).Hours;
            var minutes = TimeSpan.FromSeconds(slot.totalTime).Minutes;
            var seconds = TimeSpan.FromSeconds(slot.totalTime).Seconds;
        ...
        {
            if (slot != null && slot.initialized) slotIsInitialized.Invoke();
        }
        ...
        public void SelectSlot()
        {
            ...
            if (save.currentSlot != slotIndex) slotSelected.Invoke();
