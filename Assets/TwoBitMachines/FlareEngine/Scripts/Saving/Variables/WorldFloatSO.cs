...
namespace TwoBitMachines.FlareEngine
{
    public class WorldFloatSO : ScriptableObject
    {
        ...
        [NonSerialized] private WorldFloat reference;
        ...
        {
            if (reference != null) reference.Increment(newValue);
        }
        ...
        public void Save()
        {
            if (reference != null) reference.Save();
        }

        public void SaveManually()
        {
            if (reference != null) reference.SaveManually();
        }
    }
}