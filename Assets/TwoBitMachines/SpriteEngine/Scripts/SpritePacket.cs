...
namespace TwoBitMachines.TwoBitSprite
{
    ...
    public class SpritePacket
    {
        ...
        [SerializeField] public List<Frame> frame = new();
        ...
        public bool Transition(List<SpritePacket> sprites, SpriteTree tree, string currentAnimation,
            out SpritePacket transitionAnimation)
        {
...
#pragma warning restore 0414
    ...
    public class RandomAnimation
    {
        ...
        public static string Get(List<RandomAnimation> randomAnimations, string currentAnimation)
        {
            ...
            {
                var rAnim = randomAnimations[i];
                if (Random.value < rAnim.weight) return rAnim.animation;
            }
