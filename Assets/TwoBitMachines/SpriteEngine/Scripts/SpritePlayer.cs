...
namespace TwoBitMachines.TwoBitSprite
{
    ...
    public class SpritePlayer
    {
        ...
        [NonSerialized] private SpritePacket currentSprite;
        [NonSerialized] private int frameIndex;
        [NonSerialized] private SpritePacket nextSprite;
        [NonSerialized] private int oneFrame;
        ...
        public void Play()
        {
            ...
            if (Clock.Timer(ref counter, currentSprite.frame[frameIndex].rate) && oneFrame > 0)
            {
                ...
                {
                    looped = true;
                    if (currentSprite.loopOnce) currentSprite.onLoopOnce.Invoke();
                    if (nextSprite != null)
                    {
        ...
        private void EnterFrame(int index, bool firstFrame = true)
        {
            ...
            currentSprite.SetProperties(index, firstFrame);
        }
    }
    ...
    public class SpritePlayerUI
    {
        ...
        public void Initialize(Transform transform)
        {
            if (renderer == null) renderer = transform.GetComponent<Image>();
        }
