...
namespace TwoBitMachines.TwoBitSprite
{
    ...
    {
        public static string[] animationDirection = { "flipLeft", "flipRight", "flipUp", "flipDown", "None" };
        [SerializeField] public SpriteRenderer render;
        [SerializeField] public SpriteTree tree = new();
        ...
        [NonSerialized] public string returnAnimation;
